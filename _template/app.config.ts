...
/**
 * Store identity and native configuration for {{NAME}}.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and {{NAME}} works exactly the same either way.';
